...
nom_maf_results_rsIDs.to_csv('/work/users/n/e/nekramer/Data/CQTL/eQTL/freeze/qtl/FNF_PEER_k10_genoPC_RNAKitBatch_DNAKitBatch_nom1Mb_mafs_rsids_chr' + str(chrom) + '.txt', index = False)
